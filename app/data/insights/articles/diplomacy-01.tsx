  ...
  sections: [
    {
      ...
      subHeading: "A Legacy of Diplomatic Excellence",
      content: (
    ...
    },
    {
      ...
      subHeading: "Building Nigeria's Diplomatic Reputation",
      content: (
        <article className="grid gap-5 text-gray-700">
          <div className="grid gap-4 md:text-lg">
            <p className="text-justify">
    ...
    },
    {
      ...
      heading: "The Current Challenge",
      subHeading: "Why This Moment Matters",
      content: (
        <article className="grid gap-5 text-gray-700">
          <div className="grid gap-4 md:text-lg">
            <p className="text-justify">
    ...
    },
    {
      ...
      heading: "Conclusion",
      subHeading: "Let the Best Represent Us",
      content: (
        <article className="grid gap-5 text-gray-700">
          <div className="grid gap-4 md:text-lg">
            <p className="text-justify">
