...
import { clearSignupState, submitRole } from "@/app/redux/features/signupSlice";
...
function ObserverVerificationForm() {
  ...
  function handleFormSubmit() {
    ...
    const observerDetails = {
      ...
      observerId: observerIdDT.files as any,
    };

    updateCurrentUser(observerDetails as any);
    dispatch(
      submitRole({
        user: {
  ...
  useEffect(() => {
    if (signupState.status.roleSubmission === "rejected") {
      dispatch(
        showAlert({
    ...
    if (signupState.status.roleSubmission === "fulfilled") {
      dispatch(
        showAlert({
          message: "Account created successfully. Your observer verification is pending.",
          type: "success",
        })
      );
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-[6px] col-start-1 col-span-2">
        <label htmlFor="signup-phone-number" className="text-sm font-medium">
      ...
      <header className="text-sm col-start-1 col-span-2">
        ...
        <p className="text-gray-500 font-normal">
          Please provide your bank account details. (Optional)
        </p>
      </header>

      <div className="grid gap-[6px] col-start-1 col-span-2 md:col-span-1">
        <label htmlFor="signup-bank-name" className="text-sm font-medium">
          Bank Name
        </label>
        <AppSelect
          id="signup-bank-name"
      ...
      <div className="grid gap-[6px] col-start-1 col-span-2 md:col-span-1 md:col-start-2">
        <label htmlFor="signup-acc-number" className="text-sm font-medium">
          Account Number
        </label>
        <Input
          id="signup-acc-number"
          size="large"
      ...
      <div className="grid gap-[6px] col-start-1 col-span-2">
        <label htmlFor="signup-acc-name" className="text-sm font-medium">
          Account Name
        </label>
        <Input
          id="signup-acc-name"
      ...
      <Button
        type="primary"
        size="large"
        className="group/signup-stage-four-submit font-medium flex gap-[1ch] items-center justify-center col-span-2 mb-3"
        loading={signupState.status.roleSubmission === "pending"}
...
export default ObserverVerificationForm;
