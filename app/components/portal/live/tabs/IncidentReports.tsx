...
import LiveIncidentReportsGraph from "../graphs/LiveIncidentReportsGraph";
import Disclaimer from "@/app/components/shared/Disclaimer";

export default function IncidentReports() {
  const liveElectionData = useAppSelector((state) => state.liveElection.data)!;
  const liveElectionEndDate = moment(liveElectionData.electionDetails.endDate).toDate();
  ...
  return (
    <section>
      ...
      {liveElectionData.incidentReport && liveElectionData.incidentReport.chart.length ? (
        <React.Fragment>
          <LiveIncidentReportsGraph liveElection={liveElectionData} />
