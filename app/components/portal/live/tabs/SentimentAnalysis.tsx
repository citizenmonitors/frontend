...
import SentimentAnalysisBarChart from "../graphs/survey/SentimentAnalysisBarChart";
import { useAppSelector } from "@/app/hooks/redux";
import { binarySelectOptions, ratingSelectOptions } from "@/app/data/form";
import SentimentAnalysisPieChart from "../graphs/survey/SentimentAnalysisPieChart";
...
export default function SentimentAnalysis() {
  ...
  return (
    <section>
      {liveElectionData.sentimentAnalysis && liveElectionData.sentimentAnalysis.chart ? (
